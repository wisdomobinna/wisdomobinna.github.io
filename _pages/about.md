...
I'm a Computer Science Ph.D. Student at Georgetown University advised by Prof. Elissa Redmiles. I'm a member of the [CS Security Lab](https://seclab.cs.georgetown.edu/). My current work centers on content generated by intelligent systems: (1) Generative AI model authorship, ownership, and value, and (2) how we can leverage cues from these outputs to develop more efficient systems that are both efficient and free from harm. I hold a Master's degree from the University of Sheffield and a Bachelor's in Computer Science from the University of Port Harcourt.
